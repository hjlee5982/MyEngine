...
inline void Vector2::Transform(const Vector2& v, const matx& m, Vector2& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&v);
...
inline Vector2 Vector2::Transform(const Vector2& v, const matx& m) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector2::Transform(const Vector2* varray, size_t count, const matx& m, Vector2* resultArray) noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector2::Transform(const Vector2& v, const matx& m, Vector4& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline void Vector2::Transform(const Vector2* varray, size_t count, const matx& m, Vector4* resultArray) noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector2::TransformNormal(const Vector2& v, const matx& m, Vector2& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline Vector2 Vector2::TransformNormal(const Vector2& v, const matx& m) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline void Vector2::TransformNormal(const Vector2* varray, size_t count, const matx& m, Vector2* resultArray) noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector3::TransformNormal(const Vector3& v, const matx& m, Vector3& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat3(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline Vector3 Vector3::TransformNormal(const Vector3& v, const matx& m) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat3(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline void Vector3::TransformNormal(const Vector3* varray, size_t count, const matx& m, Vector3* resultArray) noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector4::Transform(const Vector4& v, const matx& m, Vector4& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat4(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline Vector4 Vector4::Transform(const Vector4& v, const matx& m) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat4(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline void Vector4::Transform(const Vector4* varray, size_t count, const matx& m, Vector4* resultArray) noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline bool matx::operator == (const matx& M) const noexcept
{
    using namespace DirectX;
...
inline matx::matx(const XMFLOAT3X3& M) noexcept
{
...
inline matx::matx(const XMFLOAT4X3& M) noexcept
{
    _11 = M._11; _12 = M._12; _13 = M._13; _14 = 0.f;
    _21 = M._21; _22 = M._22; _23 = M._23; _24 = 0.f;
    _31 = M._31; _32 = M._32; _33 = M._33; _34 = 0.f;
...
inline matx& matx::operator= (const XMFLOAT3X3& M) noexcept
{
    _11 = M._11; _12 = M._12; _13 = M._13; _14 = 0.f;
    _21 = M._21; _22 = M._22; _23 = M._23; _24 = 0.f;
    _31 = M._31; _32 = M._32; _33 = M._33; _34 = 0.f;
...
inline matx& matx::operator= (const XMFLOAT4X3& M) noexcept
{
    _11 = M._11; _12 = M._12; _13 = M._13; _14 = 0.f;
    _21 = M._21; _22 = M._22; _23 = M._23; _24 = 0.f;
    _31 = M._31; _32 = M._32; _33 = M._33; _34 = 0.f;
...
inline matx& matx::operator+= (const matx& M) noexcept
{
    using namespace DirectX;
    XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&_11));
    XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&_21));
...
inline matx& matx::operator*= (float S) noexcept
{
    using namespace DirectX;
    XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&_11));
    XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&_21));
...
inline matx matx::operator- () const noexcept
{
    using namespace DirectX;
...
inline matx operator+ (const matx& M1, const matx& M2) noexcept
{
    using namespace DirectX;
...
inline matx operator* (const matx& M, float S) noexcept
{
    using namespace DirectX;
...
inline matx operator* (float S, const matx& M) noexcept
{
    using namespace DirectX;
...
inline bool matx::Decompose(Vector3& scale, Quaternion& rotation, Vector3& translation) noexcept
{
    using namespace DirectX;
...
inline matx matx::Transpose() const noexcept
{
    using namespace DirectX;
...
inline void matx::Transpose(matx& result) const noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(this);
...
inline matx matx::Invert() const noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(this);
    matx R;
...
inline void matx::Invert(matx& result) const noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(this);
    XMVECTOR det;
...
inline float matx::Determinant() const noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(this);
...
_Use_decl_annotations_
inline matx matx::CreateBillboard(
...
_Use_decl_annotations_
inline matx matx::CreateConstrainedBillboard(
    const Vector3& object,
    const Vector3& cameraPosition,
...
inline matx matx::CreateTranslation(const Vector3& position) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateTranslation(float x, float y, float z) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateScale(const Vector3& scales) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateScale(float xs, float ys, float zs) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateScale(float scale) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateRotationX(float radians) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateRotationY(float radians) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateRotationZ(float radians) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateFromAxisAngle(const Vector3& axis, float angle) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreatePerspectiveFieldOfView(float fov, float aspectRatio, float nearPlane, float farPlane) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreatePerspective(float width, float height, float nearPlane, float farPlane) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreatePerspectiveOffCenter(float left, float right, float bottom, float top, float nearPlane, float farPlane) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateOrthographic(float width, float height, float zNearPlane, float zFarPlane) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateOrthographicOffCenter(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateLookAt(const Vector3& eye, const Vector3& target, const Vector3& up) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateWorld(const Vector3& position, const Vector3& forward, const Vector3& up) noexcept
{
    using namespace DirectX;
...
inline matx matx::CreateFromQuaternion(const Quaternion& rotation) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateFromYawPitchRoll(float yaw, float pitch, float roll) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateShadow(const Vector3& lightDir, const Plane& plane) noexcept
{
    using namespace DirectX;
    matx R;
...
inline matx matx::CreateReflection(const Plane& plane) noexcept
{
    using namespace DirectX;
    matx R;
    XMVECTOR planev = XMLoadFloat4(&plane);
...
inline void matx::Lerp(const matx& M1, const matx& M2, float t, matx& result) noexcept
{
    using namespace DirectX;
    XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._11));
    XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._21));
...
inline matx matx::Lerp(const matx& M1, const matx& M2, float t) noexcept
{
    using namespace DirectX;
    XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._11));
    XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._21));
...
inline void matx::Transform(const matx& M, const Quaternion& rotation, matx& result) noexcept
{
    using namespace DirectX;
    XMVECTOR quatv = XMLoadFloat4(&rotation);
...
inline matx matx::Transform(const matx& M, const Quaternion& rotation) noexcept
{
    using namespace DirectX;
    XMVECTOR quatv = XMLoadFloat4(&rotation);
...
inline void Plane::Transform(const Plane& plane, const matx& M, Plane& result) noexcept
{
    using namespace DirectX;
...
inline Plane Plane::Transform(const Plane& plane, const matx& M) noexcept
{
    using namespace DirectX;
    XMVECTOR p = XMLoadFloat4(&plane);
    XMMATRIX m0 = XMLoadFloat4x4(&M);
...
inline Vector3 Viewport::Project(const Vector3& p, const matx& proj, const matx& view, const matx& world) const noexcept
{
    using namespace DirectX;
...
inline void Viewport::Project(const Vector3& p, const matx& proj, const matx& view, const matx& world, Vector3& result) const noexcept
{
    using namespace DirectX;
    XMVECTOR v = XMLoadFloat3(&p);
    XMMATRIX projection = XMLoadFloat4x4(&proj);
...
inline Vector3 Viewport::Unproject(const Vector3& p, const matx& proj, const matx& view, const matx& world) const noexcept
{
    using namespace DirectX;
    XMVECTOR v = XMLoadFloat3(&p);
    XMMATRIX projection = XMLoadFloat4x4(&proj);
...
inline void Viewport::Unproject(const Vector3& p, const matx& proj, const matx& view, const matx& world, Vector3& result) const noexcept
{
    using namespace DirectX;
    XMVECTOR v = XMLoadFloat3(&p);
    XMMATRIX projection = XMLoadFloat4x4(&proj);
